...
BOOL CRegeditDlg::OnInitDialog() 
{
	...
	HICON listicon[2];
	listicon[0]=AfxGetApp()->LoadIcon(IDI_ICON5c);
	listicon[1]=AfxGetApp()->LoadIcon(IDI_ICON6c);
	...
	// 树形
	HICON treeicon[4];
	treeicon[0]=AfxGetApp()->LoadIcon(IDI_ICON1c);
	treeicon[1]=AfxGetApp()->LoadIcon(IDI_ICON2c);
	treeicon[2]=AfxGetApp()->LoadIcon(IDI_ICON3c);
	treeicon[3]=AfxGetApp()->LoadIcon(IDI_ICON4c);
